...
import { ButtonLogout } from "@/src/modules/auth/components"
...
const gestionItems = [
  {
    ...
    icon: <span>👥</span>,
    title: 'Tutores',
    subTitle: 'Gestión de docente',
    badge: 2
  },
  {
    path: '/dashboard/catalogo',
    icon: <span>📋</span>,
    title: 'Catálogo etiquetas',
    subTitle: 'Etiquetas de riesgo'
  },
  {
